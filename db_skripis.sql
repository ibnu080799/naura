...
-- Dumping data for table db_skripsi.tb_mitra: ~3 rows (approximately)
...
INSERT INTO `tb_mitra` (`id`, `nama`, `npwp`, `jenis_perusahaan`, `no_perusahaan`, `email_perusahaan`, `username`, `password`, `file_name`, `status`) VALUES
	(2, 'mujur', '001122', 'Drink', 234, 'Mujur', 'mujur', '08ae20c3acd8bf38e56116bc732c4c99', 'mjr', 0),
	(4, 'PT....sss', '1233', 'Food', 837363636, 'ssss@sss.com', 'setset', '123', 'assets/filedata/file-2022-01-15 18-24-52-cover.pdf', 0);
...
-- Dumping data for table db_skripsi.tb_pelamar: ~0 rows (approximately)
...
INSERT INTO `tb_profil` (`id`, `nama`, `email`, `deskripsi`, `prestasi`, `file_name`, `username`, `password`, `status`) VALUES
	(1, 'admin', 'admin', NULL, NULL, NULL, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1);
